...
void testingFunction() {
    ...
    CU_ASSERT(function_gcd3(42,56) == 14);
    CU_ASSERT(function_gcd3(48, 18) == 6);
    CU_ASSERT(function_gcd3(270, 192) == 6);
    CU_ASSERT(function_gcd3(1237, 24) == 1);
    CU_ASSERT(function_gcd3(4200000, 3780000) == 420000);
    CU_ASSERT(function_gcd3(0, 0) == 0);
...
void runAllTests() {
    ...
    CU_add_test(suite, "Question 6: Algorithm 3", testingFunction);
